...
// 检查 1 月 25-26 日
console.log('\n=== 检查 1 月 25-26 日 ===')
const datesToCheck = ['2026-01-24', '2026-01-25', '2026-01-26', '2026-01-27']
datesToCheck.forEach(dateStr => {
  const info = holidayCache.get(dateStr)
  if (info) {
    console.log(dateStr + ': isHoliday=' + info.isHoliday + ', isWorkday=' + info.isWorkday + ', remark=' + info.remark)
  } else {
