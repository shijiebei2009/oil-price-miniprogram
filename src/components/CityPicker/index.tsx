                ...
                >
                  <View className="city-item-left">
                    ...
                    <View className="city-price-row">
                      <Text className="block city-price">92#: {(city.gas92 ?? 0).toFixed(2)}</Text>
                      <Text className="block city-price city-price-95">95#: {(city.gas95 ?? 0).toFixed(2)}</Text>
                      <Text className="block city-price city-price-98">98#: {(city.gas98 ?? 0).toFixed(2)}</Text>
                      <Text className="block city-price city-price-diesel">柴油: {(city.diesel0 ?? 0).toFixed(2)}</Text>
                    </View>
                  </View>
