...
const RankPage = () => {
  ...
  const oilTypeOptions = [
    { key: 'gas92' as OilType, label: '92#', color: '#ff6b35' },
    { key: 'gas95' as OilType, label: '95#', color: '#4facfe' },
    { key: 'gas98' as OilType, label: '98#', color: '#a18cd1' },
    { key: 'diesel0' as OilType, label: '柴油', color: '#00d2ff' },
  ]
